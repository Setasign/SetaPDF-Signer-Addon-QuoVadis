<?php
/* This demo shows you how to add a document timestamp signature to
 * an existing PDF document through the QuoVadis Signing and Validation Service.
 */
...
$writer = new SetaPDF_Core_Writer_Http('QuoVadis-Timestamped.pdf');
...
// create an QuoVaids module instance
...
// set the timestamp module
$signer->setTimestampModule($module);

// timestamp the document with the use of the module
$signer->timestamp();
